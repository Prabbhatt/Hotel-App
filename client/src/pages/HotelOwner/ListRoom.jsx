...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      your room listings. Keep your hotel information up-to-date and attract more guests with accurate and appealing room details.' />
      <p className='text-gray-600 mt-8'>All </p>

      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg 
      max-h-80 overflow-y-scroll mt-4'>
