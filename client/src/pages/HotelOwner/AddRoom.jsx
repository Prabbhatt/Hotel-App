...
const AddRoom = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <Title align="left" font='outfit' title='Add Room' subTitle='Add a new room to your hotel listing. Provide details such as room type, price per night, and available amenities.' />
      ...
      cursor-pointer hover:bg-primary/90 transition' disabled={loading}>
