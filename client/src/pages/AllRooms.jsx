...
const AllRooms = () => {
    ...
    const roomTypes =["Single Bed", "Double Bed", "Suite", "Deluxe Suite",];
  ...
  return (
    ...
    pt-28 md:pt-35 md:px-16 lg:px-24'>
       <div>
         <div className='flex flex-col items-start text-left'>
          ...
          { roomsDummyData.map((room)=> (
            ...
            border-b border-gray-400 last:pb-30 last:border-0' key={room._id} >
       ...
       max-lg:mb-8 min-lg:mt-16'>
         <div className={`flex items-center justify-between px-4 py-3 
          min-lg:border-b border-grau-300 ${openFilters && 'border-b'}`}>
