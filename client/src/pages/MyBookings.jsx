...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 mx-4 md:px-16 lg:px-24 xl:px-32'>

       <Title title='My Bookings ' subTitle='Easy and quick booking management with all your past,current and upcoming reservations in one place.Plan ypur trips seamlessly with just a few clicks' 
        align='left'/>
            ...
            {bookings.map((booking)=>(
                <div key={booking._id}  className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                     ...
                     <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                        ...
                        <span className='text-xs font-inter'> ({booking.room.roomType})</span>
                        </p>
                     ...
                     <div className='flex flex-col items-start justify-center pt-3 '>
                        ...
                        {!booking.isPaid && (
                            <button onClick={()=> handlePayment(booking._id)} className='bg-blue-500 text-white px-4 py-2 rounded-2xl mt-2 hover:bg-blue-600 transition-colors duration-300 cursor-pointer'>
                                Pay Now
                            </button>
                        )}
