...
const Hero = () => {
  ...
  return (
    ...
    bg-no-repeat bg-cover bg-center h-screen'>
        <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>Your ultimate Hotel Experience Awaits!</p>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await for you at the world's 
            most exquisite hotels and resorts.
        </p>
          <form onSubmit={onSubmitHandler} className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
