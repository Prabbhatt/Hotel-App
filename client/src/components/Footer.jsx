     ...
     <div className= 'bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                       Discove the world with us. Your journey starts here, where comfort meets luxury in every stay.
                    </p>
                    <div className='flex items-center gap-3 mt-4'>
                       
                        <img src={assets.instagramIcon} alt="instagram=icon" 
                        className='w-6 '/>
                        <img src={assets.facebookIcon} alt="instagram=icon" 
                        className='w-6 '/>
                        <img src={assets.twitterIcon} alt="instagram=icon" 
                        className='w-6 '/>
                        <img src={assets.linkendinIcon} alt="instagram=icon" 
                        className='w-6 '/>
